...
public final class TabControl extends AbstractDwcComponent {
     ...
     * Important: The DIV has to exist on the parent panel, you need to call "add"
     * before passing it to the tab control.
     * 
    ...
    protected void catchUp() throws IllegalAccessException {
        ...
        /*
         * Reimplemented logic instead of calling method to avoid duplicate tabs being
         * added
         */
        tabs.forEach(n -> {
            if (n.getValue() == null) {
