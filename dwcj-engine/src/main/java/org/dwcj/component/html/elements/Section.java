...
/**
 * Component representing a {@code section} element.
 *
 * @see <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/section">HTML section
 *      Tag</a>
 *
...
@NodeName("section")
public class Section extends HtmlComponentContainer<Section> {
  ...
  /**
   * Creates a new section with the given text.
   *
   * @param text the text
   */
