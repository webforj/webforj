 ...
 * text highlighting behavior to legible enum values, and facilitates implementation of methods to
...
public interface TextHighlightable {
  ...
  enum Highlight {
    HIGHLIGHT_NONE(0), HIGHLIGHT_KEY(1), HIGHLIGHT_MOUSE(2), HIGHLIGHT_KEY_MOUSE(
        3), HIGHLIGHT_FOCUS(
            4), HIGHLIGHT_FOCUS_OR_KEY(5), HIGHLIGHT_FOCUS_OR_MOUSE(6), HIGHLIGHT_ALL(7);
  ...
  /**
   * This method returns an enum representing the current behavior of highlighting in a text control
  ...
  /**
   * This method sets the behavior of controls implementing the TextControl interface when receiving
   * focus via the keyboard, mouse, or BBjControl::focus() method FOCUS mnemonic.
   *
