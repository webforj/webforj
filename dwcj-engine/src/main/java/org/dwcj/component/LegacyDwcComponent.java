...
import org.dwcj.concern.legacy.LegacyHasProperty;
import org.dwcj.concern.legacy.LegacyHasStyle;
import org.dwcj.concern.legacy.LegacyHasText;
import org.dwcj.concern.legacy.LegacyHasTooltip;
...
public abstract class LegacyDwcComponent extends Component
   ...
   * @return The component itself
   */
  protected LegacyDwcComponent focusComponent() throws DwcjRuntimeException {
    if (this.control != null) {
      try {
        control.focus();
      } catch (BBjException e) {
