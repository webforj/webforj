 ...
 *
 * @deprecated Dwc components don't support Scrollability.
 */
@Deprecated(since = "23.05", forRemoval = true)
public interface LegacyHasScrollability {
   ...
   */
  LegacyHasScrollability setHorizontalScrollBarPosition(Integer position);
   ...
   * @return The control itself
   */
  LegacyHasScrollability setVerticalScrollBarPosition(Integer position);
}
