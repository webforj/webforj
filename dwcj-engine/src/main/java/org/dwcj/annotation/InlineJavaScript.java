...
/**
 * Annotates a class to inject a JavaScript content into the web page. The annotation can be used on
...
public @interface InlineJavaScript {
  ...
  /**
   * A unique resource id. Once the id is set, the resource will be injected only once in the page.
   *
   ...
   * be added to the script element. Attributes can be specified either as a string in the format
