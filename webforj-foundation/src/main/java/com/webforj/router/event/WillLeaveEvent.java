...
public class WillLeaveEvent extends RouteEvent {
   ...
   *
   * @param value when {@code false}, the router will be allowed to proceed to the next step and
   *        detach the route's component from the DOM; when {@code true}, the router will be vetoed
