package com.webforj.component.textarea;
...
import com.webforj.component.textarea.sink.TextAreaModifyEventSink;
...
import com.webforj.concern.legacy.LegacyHasScrollability;
...
public final class TextArea extends LegacyDwcComponent
   ...
   *
   * @return Returns whether the control is limited to one paragraph (false = Not limited, true =
   *         Limited).
   */
   ...
   *         and selectionList.getItem(1) identify the paragraph and offset of the beginning of the
   *         selected text while selectionList.getItem(2) and selectionList.getItem(3) identify the
   *         paragraph and offset of the end of the selected text. All values are zero-based. If the
   *         start and end points are the same, there is no selection and the location of the caret
  ...
  /**
   * Returns whether a vertical scroll bar will appear when the text is too large to fit within the
   * MultilineEdit control area.
   *
   * @return Returns whether a vertical scroll bar will appear when the text is too large to fit
