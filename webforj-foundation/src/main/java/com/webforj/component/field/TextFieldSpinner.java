...
public final class TextFieldSpinner extends TextField
    implements HasOptions<TextFieldSpinner>, Spinnable<TextFieldSpinner> {
   ...
   */
  public TextFieldSpinner(String label, String value, String placeholder) {
   ...
   */
  public TextFieldSpinner(String label, String value,
   ...
   * @param listener the value change listener
   */
  public TextFieldSpinner(String label, EventListener<ValueChangeEvent<String>> listener) {
   ...
   * @param listener the value change listener
   */
  public TextFieldSpinner(EventListener<ValueChangeEvent<String>> listener) {
    super(listener);
    postInit();
  }
   ...
   * @param label the label of the field
   */
  public TextFieldSpinner(String label) {
    super(label);
    postInit();
  }
   ...
   */
  public TextFieldSpinner() {
    super();
    postInit();
  }

  TextFieldSpinner(HasOptionsMixin hasOptionsMixin, SpinnableMixin spinnableMixin) {
    super();
   ...
   */
  @Override
  public TextFieldSpinner setOptions(List<String> list) {
   ...
   */
  @Override
  public TextFieldSpinner setOptionIndex(int index) {
   ...
   */
  @Override
  public TextFieldSpinner spinUp() {
   ...
   */
  @Override
  public TextFieldSpinner spinDown() {
