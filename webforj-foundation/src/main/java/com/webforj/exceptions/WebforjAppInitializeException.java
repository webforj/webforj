 ...
 */
public final class WebforjAppInitializeException extends WebforjException {
   ...
   *        unknown.)
   */
  public WebforjAppInitializeException(String message, Throwable cause) {
    super(message, cause);
  }
   ...
   *        unknown.)
   */
  public WebforjAppInitializeException(Throwable cause) {
   ...
   *        {@link #getMessage()} method.
   */
  public WebforjAppInitializeException(String e) {
    super(e);
  }
   ...
   */
  public WebforjAppInitializeException() {
