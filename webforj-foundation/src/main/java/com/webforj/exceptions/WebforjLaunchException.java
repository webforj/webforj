 ...
 */
public final class WebforjLaunchException extends WebforjRuntimeException {
   ...
   *        unknown.)
   */
  public WebforjLaunchException(String message, Throwable cause) {
    super(message, cause);
  }
   ...
   *        unknown.)
   */
  public WebforjLaunchException(Throwable cause) {
   ...
   *        {@link #getMessage()} method.
   */
  public WebforjLaunchException(String e) {
    super(e);
  }
