 ...
 */
public class WebforjException extends Exception {
   ...
   */
  public WebforjException(String message) {
    super(message);
  }
   ...
   *        unknown.)
   */
  public WebforjException(String message, Throwable cause) {
    super(message, cause);
  }
   ...
   *        unknown.)
   */
  public WebforjException(Throwable cause) {
    super(cause);
  }
   ...
   */
  public WebforjException(Exception e) {
    super(e);
  }
