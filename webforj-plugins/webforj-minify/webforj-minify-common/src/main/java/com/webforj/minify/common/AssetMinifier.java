 ...
 * }</pre>
 *
 * <p><b>IMPORTANT:</b> Implementations must be stateless and thread-safe for parallel processing.
 * Do not maintain instance state between {@link #minify(String, Path)} calls.
 */
