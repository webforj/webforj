        ...
        if (Boolean.TRUE.equals(fChangeOnly)) {
          try {
            ns.setCallbackForNamespaceChange(
                Environment.getCurrent().getDwcjHelper().getEventProxy(this, "onNsChange"),
                ON_EVENT);
          ...
          try {
            ns.setCallbackForNamespace(
                Environment.getCurrent().getDwcjHelper().getEventProxy(this, "onNsAccess"),
                ON_EVENT);
            ArrayList<Consumer<NamespaceEvent>> consumerlist =
        ...
        if (Boolean.TRUE.equals(fChangeOnly)) {
          try {
            ns.setCallbackForVariableChange(key,
                Environment.getCurrent().getDwcjHelper().getEventProxy(this, "onVarChange"),
                ON_EVENT);
            ArrayList<Consumer<NamespaceEvent>> consumerlist =
          ...
          try {
            ns.setCallbackForVariable(key,
                Environment.getCurrent().getDwcjHelper().getEventProxy(this, "onVarAccess"),
                ON_EVENT);
            ArrayList<Consumer<NamespaceEvent>> consumerlist =
