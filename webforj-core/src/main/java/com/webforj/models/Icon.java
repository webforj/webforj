...
public class Icon {
  ...
  /*
   * public Icon(String file) { try { this.file = new File(new URL(file).toURI()); } catch
   * (MalformedURLException e) { this.file = new File(file); } catch (URISyntaxException e) {
