 ...
 */
public class WebforjRuntimeException extends RuntimeException {
   ...
   */
  public WebforjRuntimeException(String message) {
    super(message);
  }
   ...
   *        unknown.)
   */
  public WebforjRuntimeException(String message, Throwable cause) {
    super(message, cause);
  }
   ...
   *        unknown.)
   */
  public WebforjRuntimeException(Throwable cause) {
    super(cause);
  }
   ...
   */
  public WebforjRuntimeException(Exception e) {
    super(e);
  }
   ...
   */
  public WebforjRuntimeException() {}
}
