 ...
 *
 * If context parameters change in a future Kotlin release, code using [String.unaryPlus] may
 * require migration to `text = "..."` syntax.
 *
 * @see HasText for the underlying interface
 */
@RequiresOptIn(
  message =
    "Relies on Kotlin context parameters. May require migration to text = \"...\" if the feature changes.",
 ...
 *
 * This function provides a convenient DSL syntax for setting the text property of any component
 * that implements [HasText]. When used within a Webforj DSL context, it allows writing code like:
 * ```kotlin
 * button {
