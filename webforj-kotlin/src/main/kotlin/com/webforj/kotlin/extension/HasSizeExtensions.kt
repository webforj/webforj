 ...
 *
 * This property allows getting and setting both width and height as a pair of strings. The first
 * element represents width and the second represents height.
 *
 * Example:
 * ```
...
var HasSize<*>.size: Pair<String, String>
  get() = width to height
  set(value) {
    setSize(value.first, value.second)
  }

/**
 * Provides a minSize property for components that implement [HasSize].
 *
 * This property allows getting and setting both minimum width and height as a pair of strings. The
 * first element represents minimum width and the second represents minimum height.
 *
 * Example:
 * ```
...
var HasSize<*>.minSize: Pair<String, String>
  ...
  set(value) {
    setMinSize(value.first, value.second)
  }

/**
 * Provides a maxSize property for components that implement [HasSize].
 *
 * This property allows getting and setting both maximum width and height as a pair of strings. The
 * first element represents maximum width and the second represents maximum height.
 *
 * Example:
 * ```
...
var HasSize<*>.maxSize: Pair<String, String>
  ...
  set(value) {
    setMaxSize(value.first, value.second)
  }
