...
/**
 * Provides [properties] property to [Component] subclasses that implement [HasProperty]. The use of
 * the property allows to clarify that a `Components` properties are to be modified and to avoid
...
/**
 * Provides the set operator for implementors of [HasProperty] allowing the use of squared brackets
 * (`[property]`) to set the value of a property:
 * ```
 * val component = ...
...
/**
 * Provides the get operator for implementors of [HasProperty] allowing the use of squared brackets
 * (`[property]`) to retrieve the value of a property, its type is inferred or has to be manually
 * cast with `as`:
 * ```
 * val component = ...
...
/**
 * Provides the get operator for implementors of [HasProperty] allowing the use of squared brackets
 * (`[property]`) to retrieve the value of a property, uses the given [KClass] to set the expected
 * type of the value:
 * ```
 * val component = ...
 * // Modifying properties
 ...
 * @see HasProperty.getProperty
 */
operator fun <V : Any> HasProperty<*>.get(property: String, classOfV: KClass<V>): V? =
  getProperty(property, classOfV.java)

/**
 * Provides the get operator for implementors of [HasProperty] allowing the use of squared brackets
 * (`[property]`) to retrieve the value of a property, uses the given [Type] to set the expected
 * type of the value:
 * ```
 * val component = ...
 * // Modifying properties
 ...
 * @see HasProperty.getProperty
 */
operator fun <V> HasProperty<*>.get(property: String, typeOfV: Type): V? =
  getProperty(property, typeOfV)
