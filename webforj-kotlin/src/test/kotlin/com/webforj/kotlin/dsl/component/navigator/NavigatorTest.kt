...
class NavigatorTest {
  ...
  @ParameterizedTest(
    name = "Create Navigator with repository, text = {0}, layout = {1} and pageSize = {2}"
  )
  @MethodSource("provideNavigatorsWithTextLayoutPageSizeAndRepository")
  fun shouldCreateNavigatorWithRepositoryTextLayoutAndPageSize(
    text: String?,
  ...
  @MethodSource("provideNavigatorsWithTextLayoutPageSizeAndRepository")
  fun shouldCreateNavigatorWithRepositoryTextLayoutPageSizeAndBlock(
    text: String?,
    layout: Navigator.Layout?,
    pageSize: Int?,
    repository: Repository<*>,
    ...
    val navigator =
      root.navigator(repository, text, layout, pageSize) {
        name = expected
      }
    Assertions.assertTrue { root.hasComponent(navigator) }
    Assertions.assertEquals(text ?: "", navigator.text)
  ...
  @ParameterizedTest(
    name = "Create Navigator with totalItems, text = {0}, layout = {1} and pageSize = {2}"
  )
  @MethodSource("provideNavigatorsWithTextLayoutPageSizeAndTotalItems")
  fun shouldCreateNavigatorWithTotalItemsTextLayoutAndPageSize(
    text: String?,
    layout: Navigator.Layout?,
    pageSize: Int?,
    totalItems: Int,
  ...
  @MethodSource("provideNavigatorsWithTextLayoutPageSizeAndTotalItems")
  fun shouldCreateNavigatorWithTotalItesmTextLayoutPageSizeAndBlock(
    text: String?,
    layout: Navigator.Layout?,
    pageSize: Int?,
    totalItems: Int,
    ...
    val expected = "Navigator"
    val navigator =
      root.navigator(text, layout, pageSize, totalItems) {
        name = expected
      }
    Assertions.assertTrue { root.hasComponent(navigator) }
    Assertions.assertEquals(text ?: "", navigator.text)
  ...
  @MethodSource("provideNavigatorsWithTextLayoutPageSizeAndRepository")
  fun shouldCreatePaginatorWithRepositoryAndPageSize(
    text: String?,
    layout: Navigator.Layout?,
    pageSize: Int?,
    repository: Repository<*>,
  ...
  @MethodSource("provideNavigatorsWithTextLayoutPageSizeAndTotalItems")
  fun shouldCreatePaginatorWithTotalItemsAndPageSize(
    text: String?,
    layout: Navigator.Layout?,
    pageSize: Int?,
    totalItems: Int,
