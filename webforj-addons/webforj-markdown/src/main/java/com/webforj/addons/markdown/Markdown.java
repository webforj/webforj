package com.webforj.addons.markdown;

import com.webforj.addons.code.Code;
...
public class Markdown extends Panel {
  ...
  public static final String PRISM_LANG_URL =
      "https://cdn.jsdelivr.net/npm/prismjs@1.29.0/components/prism-%%language%%.min.js";
  public static final String PRISM_TB_URL =
      "https://cdn.jsdelivr.net/npm/prismjs@1.29.0/plugins/toolbar/prism-toolbar.min.js";
  public static final String PRISM_TB_CSS =
      "https://cdn.jsdelivr.net/npm/prismjs@1.29.0/plugins/toolbar/prism-toolbar.min.css";
  public static final String PRISM_CLIPBOARD_URL =
  ...
  public Markdown addLanguage(String language) {
    if (Code.isSupportedLanguage(language) && !loadedLangs.contains(language)) {
      ...
      String scr =
          "function whenPrismLoaded (callback) { if (typeof Prism === 'undefined') {setTimeout (function () {whenPrismLoaded (callback);}, 100);} else { callback (); }}";
      hv.injectScript(scr);
      ...
      scr =
          "whenPrismLoaded(function() {var link2 =  document.createElement('script');link2.setAttribute('type','module');link2.setAttribute('src','"
      ...
      if (!this.clipboardButtonLoaded && !prism_loaded.contains(PRISM_TB_URL)) {
        ...
        scr =
            "whenPrismLoaded(function() {var link =  document.createElement('script');link.setAttribute('type','module');link.setAttribute('src','"
  ...
  private void loadPrismLib() {
    if (!prism_loaded.contains(PRISM_URL)) {
      String script =
          "var link =  document.createElement('script');link.setAttribute('type','module');link.setAttribute('src','"
              + PRISM_URL + "');" + "document.head.appendChild(link);"
              + "var csslink =  document.createElement('link');"
              + "csslink.setAttribute('rel','stylesheet');" + "csslink.setAttribute('href','"
              + PRISM_CSS + "');" + "document.head.appendChild(csslink);";
