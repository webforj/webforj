package com.webforj.component.youtube;
 ...
 */
@NodeName("iframe")
@InlineStyleSheet(id = "webforj-youtube-widget", once = true, value = /* css */ """
    [webforj-youtube-container] {
      width: 100%;
    ...
    [webforj-youtube-container] iframe {
...
public class Youtube extends ElementComposite
  ...
  public Youtube() {
    ...
    current.setAttribute("webforj-youtube", "");
    ...
    whenAttached().thenAccept(element -> {
      ...
      container.setAttribute("webforj-youtube-container", "");
      container.add(this);
   ...
   *
   * <p>
   * The option value is an <a href="http://www.loc.gov/standards/iso639-2/php/code_list.php">ISO
   * 639-1 two-letter language code</a> or a fully specified locale. For example, <code>fr</code>
   * and <code>fr-ca</code> are both valid values. Other language input codes, such as
   * <code>IETF</code> language tags (BCP 47) might also be handled properly.
   *
