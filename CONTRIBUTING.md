...
the "**target**" folder. Inside this folder, you should see the "**dwcj-engine-XX.XX.jar**" file, with the X's replaced by numeric values. The path may look similar to "**C:\engine\target\dwcj-engine-XX.XX.jar**". Select the .jar file and then click the "**Open**"
button.
