...
class LabelWrapContributionTest {

  private final LabelWrapContribution contribution = new LabelWrapContribution();

  @ParameterizedTest
  @ValueSource(booleans = {true, false})
  void shouldGet(boolean value) {
    Label component = mock(Label.class);
    when(component.isWrap()).thenReturn(value);
  ...
  void shouldSet(boolean value) {
    ...
    verify(component).setWrap(value);
  }
}
