...
public class ClassDemoWithInterface extends App {
    ...
    public void run() throws DwcAppInitializeException {
        ...
        Label headline = new Label("<html><h1>Using BBj Classes that implement Java Interface</h1>");
        panel.add(headline);
        ...
        programsource = "use java.math.BigDecimal\n" +
                "use org.dwcj.extendeddemos.bbjclasses.BBjClassDemoIF\n\n" +
                "CLASS PUBLIC MyClass IMPLEMENTS BBjClassDemoIF\n\n" +
    ...
    private void onExecClick(ButtonPushEvent buttonPushEvent) {
        ...
        BBjClassDemoIF obj = (BBjClassDemoIF) helper.createInstance(classname);

        BigDecimal factor1 = new BigDecimal(ipa.getText());
        BigDecimal factor2 = new BigDecimal(ipb.getText());
        BigDecimal retval  = obj.multiply(factor1, factor2);
